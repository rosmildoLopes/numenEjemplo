      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-6xl font-bold text-foreground mb-6">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-main to-accent pb-2">
              no es un objetivo&quot;
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-11/12 mx-auto">
          {metrics.map((metric, index) => (
            <Card 
              key={metric.label} 
              className="text-center hover-lift border-0 shadow-md bg-white/80 backdrop-blur-lg  hover:-translate-y-2 hover:shadow-sm hover:shadow-accent duration-400 transition"
