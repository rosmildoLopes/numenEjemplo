      ...
      <div className="relative z-10 flex items-center h-full px-8 md:px-16 lg:px-24">
        <div className="max-w-5xl text-left"> 
          <h1 className="text-4xl md:text-6xl font-black text-gray-700 leading-tight mb-6">
            La transformación digital <br /> no es tecnológica, <br /> <span className="md:text-7xl block text-transparent bg-clip-text bg-gradient-to-r from-main to-verde">es cultural</span>
          </h1>
